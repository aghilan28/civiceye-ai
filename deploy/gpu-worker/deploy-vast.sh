...
docker compose --env-file .env.gpu-worker -f docker-compose.gpu-worker.yml pull || true
...
docker compose --env-file .env.gpu-worker -f docker-compose.gpu-worker.yml logs --tail=80 inference-worker-gpu
